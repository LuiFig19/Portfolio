...
export const sections = {
  hardware: {
    ...
    body:
      "Two custom KiCad PCBs at the top - the Air Sensor and a drone flight controller - drawn from schematic to bring-up by me. Below them, three finished products: the Mesh Motion Sensor, the Astra Air Sensor, and the Network Monitor. All ESP32-S3, all running today in a home lab.",
  ...
  field: {
    ...
    body:
      "Production lead at Ravens Marine - running the welding floor and qualifying junior welders for production work. Evenings and weekends: contract field IT for Fanatic Node - Windows recovery, drive and RAM upgrades, BitLocker resets, admin-password recovery, PoE camera installs. The home lab in the background is where the PCBs above actually live.",
    stack: [
  ...
  availability: {
    ...
    bring: [
      ...
      "Production-floor leadership at Ravens Marine - qualifying junior welders for production work",
